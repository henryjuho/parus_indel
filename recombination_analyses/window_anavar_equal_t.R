...
in_file = 'gt_windows_noncoding_continuous_equal_t_results.windowdata.csv'
out_stem = 'continuous'
...
# saving
png(file=paste(out_stem, 'window_anavar_equal_t.png', sep='_'), width=9, height=6, units='in', res=360)
