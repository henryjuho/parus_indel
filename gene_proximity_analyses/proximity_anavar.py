...
def main():
    ...
    parser.add_argument('-call_txt', default='/home/bop15hjb/parus_indel/summary_analyses/bgi10_call.txt',
                        help=argparse.SUPPRESS)
    parser.add_argument('-equal_theta', help='if specified runs with equal mutation rates between neu and sel sites',
