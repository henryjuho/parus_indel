# Title     : distance anavar 5kb nc with UCNEs and genes
...
prox_data = subset(read.csv('gt_sel_neu_ref_conserveddist_5kb.results.csv'), bin!='43-137')
...
png(file='distance_estimates_5kb_nc_UCNE.png', width=9, height=3, units='in', res=360)
