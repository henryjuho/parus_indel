# Title     : distance anavar 500bp nc with UCNEs and genes
...
prox_data = subset(read.csv('gt_sel_neu_ref_conserveddist_500bp.results.csv'), bin!='129-1363')
...
prox_data$distance = as.numeric(prox_data$bin) * 500
...
png(file='distance_estimates_500bp_nc_UCNE.png', width=9, height=3, units='in', res=360)
